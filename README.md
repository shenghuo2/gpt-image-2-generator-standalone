...
<p align="center">纯静态图片生成站，浏览器直连 OpenAI 兼容 API，无需后端，刷新即忘。</p>

## 快速开始

| 方式 | 地址 |
|------|------|
| 在线 | **[shenghuo2.github.io/gpt-image-2-generator-standalone](https://shenghuo2.github.io/gpt-image-2-generator-standalone/)** <br> <sub>GitHub Pages 域名可能有 DNS 污染，需使用魔法上网</sub> |
